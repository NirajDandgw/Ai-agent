...
exports.ConfigurationValidator = exports.ValidationError = void 0;
...
class ConfigurationValidator {
     ...
     */
    static validateJobConfiguration(config, options) {
     ...
     */
    static validateJobConfigurationStrict(config) {
    ...
    static validateJobIdentifiers(config, errors) {
        // Job ID validation
    ...
    static validateSchedule(schedule, errors) {
    ...
    static validateDuration(duration, errors) {
    ...
    static validateLogPaths(logPaths, errors, options) {
    ...
    static validateAlertChannels(channels, options) {
        const errors = [];
        const warnings = [];
    ...
    static validateCrossFieldConstraints(config, errors, warnings) {
    ...
    static validateDataSourceConfig(config, options) {
        const opts = { ...this.DEFAULT_OPTIONS, ...options };
        const errors = [];
        const warnings = [];
        if (!config) {
    ...
    static validateSLAThresholds(thresholds, options) {
        const errors = [];
        const warnings = [];
        if (!thresholds) {
    ...
    static validateAlertChannel(channel, fieldPrefix = 'alertChannel', options) {
        const opts = { ...this.DEFAULT_OPTIONS, ...options };
        const errors = [];
        const warnings = [];
        if (!channel) {
    ...
    static validateCredentialConfig(credentials, fieldPrefix, options) {
        const errors = [];
        const warnings = [];
        if (!credentials) {
     ...
     */
    static validateConfigurationParameters(config) {
     ...
     */
    static ensureDataIntegrity(config) {
...
ConfigurationValidator.DEFAULT_OPTIONS = {
    strict: true,
    allowEmptyCredentials: false,
    maxLogPaths: 10,
    maxAlertChannels: 5
